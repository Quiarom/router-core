...
- **GitHub:** open a private security advisory (see
  [SUPPORT.md](.github/SUPPORT.md) for the workflow).
- **Email:** the address listed in the latest git tag of
  `NOTICE` or the repository `OWNERS` file.
